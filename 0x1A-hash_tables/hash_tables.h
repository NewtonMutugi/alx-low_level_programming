...
void hash_table_delete_key(hash_table_t *table, const char *key);
char *hash_table_get(const hash_table_t *table, const char *key);
int hash_table_set(hash_table_t *ht, const char *key, const char *value);
void hash_table_print(const hash_table_t *ht);
void hash_table_print_key(const hash_table_t *ht, const char *key);
void hash_table_print_value(const hash_table_t *ht, const char *value);


/* for 100-sorted_hash_table*/
/**
